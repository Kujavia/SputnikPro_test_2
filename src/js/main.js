...
window.updateUserImage = function() {
  ...
  const images = {
      option1: './src/image/person.jpg', // Путь к изображению для нового пользователя
      option2: './src/image/user1.png', // Путь к изображению Зилевич Елизаветы
      option3: './src/image/MalikaIsahanova.jpg', // Путь к изображению Исахановой Малики
      option4: './src/image/user1.png', // Путь к изображению Ткачёва Олега
      option5: './src/image/user1.png' // Путь к изображению Шварёва Данила
  };
